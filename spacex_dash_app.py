...
def get_graph(entered_site, payload):
...
# Q1 answer: KSC LC-39A has the largest successful launches

## Q2: Which site has the highest launch success rate?
# Q2 answer: CCAFS SLC-40 has the highest launch success rate

## Q3:Which payload range(s) has the highest launch success rate?
# Q3 answer: payload ranges of 2000 to 4000 kg have the highest launch success rate

## Q4: Which payload range(s) has the lowest launch success rate?
# Q4 answer: payload ranges 2000 to 4000kg or 4000 to 6000kg has the lowest launch success rate

## Q5: Which F9 Booster version (v1.0, v1.1, FT, B4, B5, etc.) has the highest launch success rate?
#Q5 answer: the F9 booster version FT has the highest launch success rate